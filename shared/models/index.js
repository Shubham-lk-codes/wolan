...
const SupportTicketSchema = tenantSchema({ subject: { type: String, required: true }, message: { type: String, required: true }, priority: { type: String, enum: ['NORMAL', 'HIGH', 'CRITICAL'], default: 'NORMAL' }, assignedTo: { type: objectId, ref: 'User' }, resolvedAt: Date });
